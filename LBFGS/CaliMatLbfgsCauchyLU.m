function [X,z,info,itr,time_used] = CaliMatLbfgsCauchyLU(G,ConstrA,OPTIONS,z0)
...
for itr = 1 : maxit
    ...
    if itr>1      %第一步向负梯度方向走，不求柯西点
        ...
        gc=[gc_ze;gc_zlu];
        [ds_e, ds_lu]=getDs(S, Y, lr-1, start_index, gamma, M, k_e, k_lu, C1, C2, C3, B, zc_lu, zb_l,gc);%get the search direction at cauchy poin
